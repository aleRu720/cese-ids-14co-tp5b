 ...
 *
 * Esta función se utiliza para convertir los datos estructurados en memoria
 * en una cadena de texto que pueda ser transmitida por un puerto de comunicaciones.
 * Se utiliza el formato JSON proveniente de JavaScript y muy difundido
 * en las aplicaciones web.
 * 
 * @param[out] cadena       Puntero a la cadena de caracteres de resultado
 ...
 * @return true             Los datos se pudieron serializar correctamente.
 * @return false            Los datos NO se pudieron serializar.
 */
 ...
 * @brief 
 * 
 * @param cadena    Puntero a la cadena de caracteres de resultado
